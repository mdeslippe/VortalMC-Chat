...
public class HelpCommand extends CommandListener {
	...
	public HelpCommand() {
		...
		(String[]) VortalMCChat.getInstance().getFileManager().getFile("commands").getConfiguration().getStringList("VortalMCChat.Subcommands.Help.Aliases").toArray(new String[0])
		);
	}
	...
	public void onCommand(CommandSender sender, String[] args) {
		...
		for(String index : messages.getStringList("VortalMC-Chat.Base-Command.Sub-Commands.Help-Command.Message")) {
